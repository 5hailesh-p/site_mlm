                        ...
                        <div className="col-lg-12">
                            <div className="single-blog-details">
                                <div className="content">
                                    <a>
                                        <h4 className="title">
                                            <span style={{ color: "#970810" }}>Single Leg MLM Plan</span>
                                        </h4>
                                    </a>
                                    <div className="text-area">
                                        <div className="row">
                                            <div className="col-lg-7 col-md-7 col-sm-12">
                                                ...
                                                <h3>
                                                    Awesome Features For Single Leg MLM Software
                                                </h3>
                                            ...
                                            <div className="col-lg-4 col-md-5 col-sm-12">
                                                <img src="/img/plan/p4.png" alt="Binary tree codechroma" />
                                            </div>
                                        </div>
