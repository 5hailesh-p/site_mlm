                    ...
                    <div className="col-lg-7">
                      <div className="text-area">
                        <p style={{ fontSize: "1rem", fontWeight: "400;" }}>
                          {import.meta.env.VITE_SITE_NAME} solutions is a leading MLM software provider available in the market at present. {import.meta.env.VITE_SITE_NAME} was formed with an aim to deliver full-featured, customizable solutions with timely upgraded technologies in a reasonable price and to provide round the clock client support (24x7). We have a team of highly experienced MLM developers who has the potential to make a breakthrough in developing multi-level marketing software. With the support of our diligent and professional team, our company aims to cater to our clients' need with brilliance. We fabricate, develop and design the software. Our team has comprehensive system knowledge which assures you of top-notch services from {import.meta.env.VITE_SITE_NAME}.
                        </p>
                        <p>
